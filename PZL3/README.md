...
This puzzle is one from the series of Arweave Puzzles made by @Tiamat (official Arweave project discord member, apps developer, miner, early investor). Originally, puzzle posted in official @Tiamat twitter [1]: with hints and link to the blockchain [2] 
...
Some think that it could be a point to UpVest that invested in arweave some funds [9]
